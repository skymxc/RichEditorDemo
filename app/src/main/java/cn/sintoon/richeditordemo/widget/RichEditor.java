...
import cn.sintoon.richeditordemo.util.Utils;

/**
 * Created by mxc on 2018/9/6.
 * description: 富文本编辑器
 */
public class RichEditor extends WebView {
    ...
    private static final String CALLBACK_SCHEME_WITH_SUFFIX = "re-callback://";
    private static final String STATE_SCHEME_WITH_SUFFIX = "re-state://";
    ...
    protected class EditorWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                ...
                String decode;
                try {
                    Log.e(EditorWebViewClient.class.getSimpleName() + "", "shouldOverrideUrlLoading->uri-" + string);
                    decode = URLDecoder.decode(string, "UTF-8");
                } catch (UnsupportedEncodingException e) {
                    // No handling
                    return false;
                }
                Log.e(EditorWebViewClient.class.getSimpleName() + "", "shouldOverrideUrlLoading->decode-" + decode);

                String scheme = uri.getScheme();
                switch (scheme) {
                    case CALLBACK_SCHEME:
                        callback(decode);
                        return true;
                    case STATE_SCHEME:
                        stateCheck(decode);
